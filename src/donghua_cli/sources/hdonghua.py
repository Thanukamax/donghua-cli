...
Uses the AnimeStream WordPress theme. Advertises 4K/FHD/HD content.
"""
...
class HDonghua(Source):
    ...
    _SEARCH_SELS = ["div.bsx", "article.bs", "div.bs"]
    _EP_SELECTORS = [".eplister a", ".episodelist a", ".epwrapper a", "#chapterlist a"]
